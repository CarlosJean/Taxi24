...
namespace Taxi24.Data.Migrations
{
    ...
    [Migration("20210503185859_OneToManyConventionAdded")]
    partial class OneToManyConventionAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Taxi.Core.Models.Trip", b =>
                {
                    b.HasOne("Taxi.Core.Models.Driver", "Driver")
                        .WithMany()
                        .HasForeignKey("DriverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Taxi.Core.Models.Fare", "Fare")
                        .WithMany()
                        .HasForeignKey("FareId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Taxi.Core.Models.Passenger", "Passenger")
                        .WithMany()
